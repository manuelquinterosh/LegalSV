...
public class ConstitutionsRecyclerViewAdapter extends RecyclerView.Adapter<ConstitutionsRecyclerViewAdapter.MyViewHolder> {

    private Context mContext;
    private List<Menu> mItems;
    private CustomItemClickListener mClickListener;

    public ConstitutionsRecyclerViewAdapter(Context context, List<Menu> items, CustomItemClickListener clickListener) {
        mContext = context;
        mItems = items;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
       ...
       final ConstitutionsRecyclerViewAdapter.MyViewHolder holder = new ConstitutionsRecyclerViewAdapter.MyViewHolder(view);
    ...
    private void showPopupMenu(View view) {
        ...
        popup.setOnMenuItemClickListener(new ConstitutionsRecyclerViewAdapter.MyMenuItemClickListener());
        popup.show();
    }
