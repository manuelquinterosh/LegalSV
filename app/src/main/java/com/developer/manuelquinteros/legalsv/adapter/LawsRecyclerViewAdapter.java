...
public class LawsRecyclerViewAdapter extends RecyclerView.Adapter<LawsRecyclerViewAdapter.MyViewHolder>{
    ...
    public LawsRecyclerViewAdapter(Context context, List<Menu> items, CustomItemClickListener clickListener) {
        mContext = context;
        mItems = items;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        final LawsRecyclerViewAdapter.MyViewHolder holder = new LawsRecyclerViewAdapter.MyViewHolder(view);
    ...
    private void showPopupMenu(View view) {
        ...
        popup.setOnMenuItemClickListener(new LawsRecyclerViewAdapter.MyMenuItemClickListener());
        popup.show();
    }
